...
\label{ch:conclusion}
	Esta dissertação propôs um novo método semiautomático para obter funções de transferência, baseado na média da terceira derivada do volume na direção do gradiente, em função de seus valores escalares. Este método, inspirado no trabalho de \textit{Kindlmann e Durkin}~\cite{gordon} (com o qual foi comparado), mostrou resultados equivalentes ou superiores quanto à exatidão do centro das fronteiras detectadas.
