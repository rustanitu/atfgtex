...
\begin{figure}[h]
	\centering
	\subfigure[Malha regular estruturada]
	{
		\includegraphics[width=0.3\textwidth]{images/regular_mesh}
		\label{fig:meshes}
	}
	\hspace{10mm}
	\subfigure[Malha não regular estruturada]
	{
		\includegraphics[width=0.3\textwidth]{images/irregular_mesh}
		\label{fig:meshes}
	}
	\caption{Lalala...}
\end{figure}
