...
%	\subfigure[]
%	{
%		\includegraphics[width=0.3\textwidth]{images/res_bucky_gordon_ft}
%		\label{fig:}
%	}
%	\subfigure[]
%	{
%		\includegraphics[width=0.3\textwidth]{images/res_nucleon_gordon_ft}
%		\label{fig:}
%	}
%	\subfigure[]
%	{
%		\includegraphics[width=0.3\textwidth]{images/res_vismale_gordon_ft}
%		\label{fig:}
%	}
%	\caption{.}
...
%	\subfigure[]
%	{
%		\includegraphics[width=0.5\textwidth]{images/res_bucky_gordon}
%		\label{fig:}
%	}
%	\subfigure[]
%	{
%		\includegraphics[width=0.5\textwidth]{images/res_nucleon_gordon}
%		\label{fig:}
%	}
%	\subfigure[]
%	{
%		\includegraphics[width=0.5\textwidth]{images/res_vismale_gordon}
%		\label{fig:}
%	}
%	\caption{.}
