...
\begin{figure}[H]
	...
	\subfigure[]
	{
		\includegraphics[width=0.3\textwidth]{images/g_bucky_ft}
		%\label{fig:}
	}
	\subfigure[]
	{
		\includegraphics[width=0.3\textwidth]{images/g_nucleon_ft}
		%\label{fig:}
	}
	\subfigure[]
	{
		\includegraphics[width=0.3\textwidth]{images/g_vismale_ft}
		%\label{fig:}
	}
	\caption{.}
