...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SPHERES %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	...
	Além disso, a fronteira \quote{mais importante}, aquela que apresenta maior variação de valores, também não foi identificada pelo método de \textit{Kindlmann e Durkin}, mas foi detectada pelo método aqui proposto, com maior intensidade.
...
\begin{figure}[h]
	...
	\subfigure[]
	{
		\includegraphics[width=0.8\textwidth]{images/r_m_knee_ft}
	}
	\subfigure[]
	{
