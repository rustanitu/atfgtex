...
\begin{figure}[h]
	\centering
	\frame{\includegraphics[width=0.25\textwidth]{images/r_vrep_so_2_slice_}}
	\caption{Fatia de um reservatório de petróleo cúbico.}
...
\end{figure}
	...
	A figura acima mostra uma fatia da simulação de um reservatório de petróleo retangular, chamado \quote{Caixa de sapato}, com um poço injetor à esquerda e um produtor à direita. A propriedade simulada é a saturação de óleo. No lado esquerdo da fatia é possível perceber um cone, com sua base voltada para baixo. A parte interna do cone é preta e faz fronteira com seu contorno que possui uma tonalidade de cinza claro. Por sua vez, este contorno faz fronteira com o resto do volume em um tom de cinza mais escuro.
...
\end{figure}
	...
	A figura acima mostra uma fatia do volume \quote{Caixa de sapato} com a propriedade saturação de gás. Nela, nota-se que a fronteira principal se encontra entre o preto e o cinza claro, criando um formato de escada.
...
\begin{figure}[h]
	...
	\caption{Visualização do volume \quote{Caixa de sapato} com a propriedade saturação de gás.}
	\label{fig:r_box_sg}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Funções de transferência do volume \quote{Caixa de sapato} com a propriedade saturação de gás.}
